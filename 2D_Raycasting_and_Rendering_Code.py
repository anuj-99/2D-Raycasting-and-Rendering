...
b1 = Boundary((0, 0), (scene_w, 0))
b2 = Boundary((0, scene_h), (scene_w, scene_h))
b3 = Boundary((scene_w, 0), (scene_w, scene_h))
b4 = Boundary((0, 0), (0, scene_h))
b5 = Boundary((0, 200), (100, 200))
b6 = Boundary((200, 200), (250, 200))
b7 = Boundary((250, 100), (250, 200))
b8 = Boundary((250, 100), (400, 100))
b9 = Boundary((550, 0), (550, 200))
b10 = Boundary((400, 200), (400, 350))
b11 = Boundary((400, 350), (600, 350))
b12 = Boundary((250, 300), (250, 500))
b13 = Boundary((250, 400), (100, 400))
walls.append(b1)
walls.append(b2)
walls.append(b3)
walls.append(b4)
